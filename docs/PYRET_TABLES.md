...
Spyret's [upstream Pyret CI](../.github/workflows/test.yml) runs table cases
through an unmodified Pyret runtime, including nested tables and shared cells.
Spyret-IDE separately checks the browser diagram path. See
[Core #599](https://github.com/sidprasad/spytial-core/issues/599) for the
original table representation work.
